...
# Retuned #
["Retuned"]="
--TimeLimit 10800 --LowerBoundGapHillClimbing 2.3025 --Weight TS 0.3313 --Weight RS 0.1241 --Weight PRS 0.5984 --Weight C 0.7227 --ConstrViolationCost 19649 --Weight MinCost_M_MinCost_PR 0 --Weight iPTS_Random_PR 0.0455 --Weight iPTS_MinCost_PR 1.7094 --Weight Random_BM 0.5962 --Weight MinCost_BM 0.8393 --Weight Random_M_Random_PR 0.8468 --Weight Random_M_MinCost_PR 0.7782"
)
...
do
	echo $c
		...
		min=999999999
			...
			DIR="$VSC_DATA_VO_USER/iRR_new/Ablation/Iteration_2"
			STDOUT="${DIR}/${c}-${f}-${r}.stdout"
